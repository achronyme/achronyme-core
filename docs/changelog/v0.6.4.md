...
version: "0.6.4"
date: 2025-11-17
title: "IEEE 754 Compliance, Short-Circuit Operators & Range Operator"
description: "IEEE 754 special values, improved logical operators with short-circuit evaluation, range operator for sequences and iteration"
breaking: false
status: "Released"
highlights:
...
- **Bug Fix: Type Pattern Bindings**: Type patterns in destructuring now correctly bind variables
- **Special Value Functions**: `isnan()`, `isinf()`, `isfinite()` for robust numeric code
- **Improved Documentation**: Clearer operator semantics, type pattern behavior, and examples
